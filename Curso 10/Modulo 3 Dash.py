...
# Create a new column for Booster Version Category by slicing the Booster Version column
spacex_df['Booster Version Category'] = spacex_df['Booster Version'].str[3:5]
